...
public class MessageConfig implements WebMvcConfigurer {
    ...
    public LocaleResolver localeResolver() {
        ...
        localeResolver.setSupportedLocales(Arrays.asList(Locale.ENGLISH, Locale.GERMAN, Locale.ITALIAN));
    ...
    public LocaleChangeInterceptor localeChangeInterceptor() {
        ...
        lci.setParamName("lang"); // Allow changing locale via 'lang' request parameter
        return lci;
    }
